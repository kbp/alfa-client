...
namespace ALFA_Client.ClientServiceReference {
    ...
    public interface IClientService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IClientService/SetKeyMass", ReplyAction="http://tempuri.org/IClientService/SetKeyMassResponse")]
        bool SetKeyMass(byte[] key, string portName, byte[] controllerNumbers, byte cellNumber, string name, byte type, System.DateTime endDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IClientService/UnsetKeyMass", ReplyAction="http://tempuri.org/IClientService/UnsetKeyMassResponse")]
    ...
    public partial class ClientServiceClient : System.ServiceModel.DuplexClientBase<ALFA_Client.ClientServiceReference.IClientService>, ALFA_Client.ClientServiceReference.IClientService {
        ...
        public bool SetKeyMass(byte[] key, string portName, byte[] controllerNumbers, byte cellNumber, string name, byte type, System.DateTime endDate) {
            return base.Channel.SetKeyMass(key, portName, controllerNumbers, cellNumber, name, type, endDate);
        }
        
        public bool UnsetKeyMass(string portName, byte[] controllerNumbers, byte cellNumber) {
            return base.Channel.UnsetKeyMass(portName, controllerNumbers, cellNumber);
        }
    }
}
